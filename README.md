...
- [Setup Guide](#setup-guide)
    - [1. Obtain your Listen Notes API Key](#1-obtain-your-listen-notes-api-key)
        - [Why Listen Notes and not Spotify?](#why-listen-notes-and-not-spotify)
    - [2. Initialise the custom GPT](#2-initialise-the-custom-gpt)
    - [3. Define the instructions](#3-define-the-instructions)
        - [Brief explanation of the instructions I gave](#brief-explanation-of-the-instructions-i-gave)
    - [4. Configure the searchPodcasts action and save](#4-configure-the-searchpodcasts-action-and-save)
